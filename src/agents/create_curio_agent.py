...
def create_curio_agent(chroma_client: PersistentClient) -> FrankenAgent:
    """Create a FrankenAgent instance."""
    
    # Load system prompt from file
    system_prompt_path = Path("agent_files/Curio/system_prompt.md")
    ...
    config = AgentConfig(
        ...
        agent_name="Curio",
        description="Internet Researcher",
        enabled_tools=["agent_search", "list_agents", "web_search"],
        api_port=8016,  # Adjust port as needed
        log_path=Path("logs"),
